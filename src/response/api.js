...
export const getGroupFolders = (item_id) => {
    ...
    axios
        ...
        .then(response => {
			...
			group_folders.value = response?.data?.map(folder => ({
				...folder,
			...
			console.log('group_folders', group_folders.value);
        })
        .catch(error => {
            console.error(error);
        })

    ...
    <div class="wrap-body m-b-15 flex items-center result-info-1439">
        ...
        >
            <svg fill="#A7B1C2" class="sort-by-metric prompt-parent" 
                    ...
                    @click="select_metric('likes')" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" style="width: 33px;padding-bottom: 5px;" viewBox="0 0 2182 2087" enable-background="new 0 0 2182 2087" xml:space="preserve">
